...
//			ObjectPrx base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.1 -p 10000 -z : udp -h 127.0.0.1 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
			...
			do {
				try {
					...
					switch (line) {
						case "avg":
							double avg = obj1.avg(new long[]{1, 2, 3, 4});
							System.out.println(avg);
							try{
								obj1.avg(new long[]{});
							} catch (EmptySequence e) {
								System.out.println("Empty sequence");
							}
							break;
                        case "add":
							r = obj1.add(7, 8);
							long r2 = obj2.add(10,15);
